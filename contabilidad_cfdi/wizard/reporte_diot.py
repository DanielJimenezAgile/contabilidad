...
class ReporteDIOTWizard(models.TransientModel):
    ...
    year = fields.Selection([('2020','2020'),('2019','2019'), ('2018','2018'), ('2017','2017')], string="Año", required=1)
                            ...
                            for tax_line,values in tax_lines.items():
                                if payment.payment_type == 'outbound':
                                    ...
                                    if tax_used.amount == 16.0 and partner.rfc != 'XEXX010101000' and not payment.diot_no_acreditable:      #ocho
                                        line_vals[partner_id].update({'pagado_16_15_amount': values * paid_pct + line_vals[partner_id].get('pagado_16_15_amount',0)})
                                    elif tax_used.amount == 15.0 and partner.rfc != 'XEXX010101000' and not payment.diot_no_acreditable:      #nueve
                                        line_vals[partner_id].update({'pagado_15_amount': values * paid_pct + line_vals[partner_id].get('pagado_15_amount',0)})
                                    elif tax_used.amount == 16.0 and partner.rfc != 'XEXX010101000' and payment.diot_no_acreditable:      #diez
                                        line_vals[partner_id].update({'pagado_16_amount_no_acreditable': values * paid_pct + line_vals[partner_id].get('pagado_16_amount_no_acreditable',0)})
                                    elif tax_used.amount == 11.0 and partner.rfc != 'XEXX010101000' and not payment.diot_no_acreditable:      #once
                                        line_vals[partner_id].update({'pagado_11_10_amount': values * paid_pct + line_vals[partner_id].get('pagado_11_10_amount',0)})
                                    elif tax_used.amount == 11.0 and partner.rfc != 'XEXX010101000' and not payment.diot_no_acreditable:      #doce
                                        line_vals[partner_id].update({'pagado_10_amount': values * paid_pct + line_vals[partner_id].get('pagado_10_amount',0)})
                                    elif tax_used.amount == 8.0 and partner.rfc != 'XEXX010101000' and not payment.diot_no_acreditable:      #trece
                                        line_vals[partner_id].update({'pagado_8_amount': values * paid_pct + line_vals[partner_id].get('pagado_8_amount',0)})
                                    elif tax_used.amount == 11.0 and partner.rfc != 'XEXX010101000' and payment.diot_no_acreditable:      #catorce
                                        line_vals[partner_id].update({'pagado_11_amount_no_acreditable': values * paid_pct + line_vals[partner_id].get('pagado_11_amount_no_acreditable',0)})
                                    elif tax_used.amount == 8.0 and partner.rfc != 'XEXX010101000' and payment.diot_no_acreditable:      #quince
                                        line_vals[partner_id].update({'pagado_8_amount_no_acreditable': values * paid_pct + line_vals[partner_id].get('pagado_8_amount_no_acreditable',0)})
                                    elif tax_used.amount == 16.0 and partner.rfc == 'XEXX010101000' and not payment.diot_no_acreditable:       #dieciseis
                                        line_vals[partner_id].update({'importacion_16': values * paid_pct + line_vals[partner_id].get('importacion_16',0)})
                                    elif tax_used.amount == 16.0 and partner.rfc == 'XEXX010101000' and payment.diot_no_acreditable:       #diecisiete
                                        line_vals[partner_id].update({'importacion_16_na': values * paid_pct + line_vals[partner_id].get('importacion_16_na',0)})
                                    elif tax_used.amount == 11.0 and partner.rfc == 'XEXX010101000' and not payment.diot_no_acreditable:       #dieciocho
                                        line_vals[partner_id].update({'importacion_11': values * paid_pct + line_vals[partner_id].get('importacion_11',0)})
                                    elif tax_used.amount == 11.0 and partner.rfc == 'XEXX010101000' and payment.diot_no_acreditable:       #diecinueve
                                        line_vals[partner_id].update({'importacion_11_na': values * paid_pct + line_vals[partner_id].get('importacion_11_na',0)})
                                    elif tax_used.amount == 0.0 and partner.rfc == 'XEXX010101000' and tax_used.tipo_factor == 'Exento': #veinte
                                        line_vals[partner_id].update({'importacion_exento': values * paid_pct + line_vals[partner_id].get('importacion_exento',0)})
                                    elif tax_used.amount == 0.0 and partner.rfc != 'XEXX010101000' and tax_used.tipo_factor != 'Exento': #veintiuno
                                        line_vals[partner_id].update({'pagado_0_amount': values * paid_pct + line_vals[partner_id].get('pagado_0_amount',0)})
                                    elif tax_used.amount == 0.0 and partner.rfc != 'XEXX010101000' and tax_used.tipo_factor == 'Exento': #veintidos
                                        line_vals[partner_id].update({'pagado_exento': values * paid_pct + line_vals[partner_id].get('pagado_exento',0)})
                                        ...
                                        line_vals[partner_id].update({'iva_retenido': values * paid_pct + line_vals[partner_id].get('iva_retenido',0)})
                                    else:
                                        line_vals[partner_id].update({'iva_devoluciones': values * paid_pct + line_vals[partner_id].get('iva_devoluciones',0)})
